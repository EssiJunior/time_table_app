...
class Classe(Base):
    ...
    effectif = Column(Integer, nullable = False)   
    niveau = Column(String(6), ForeignKey("niveau.code", ondelete="CASCADE"), nullable = False)
...
class Cours(Base):
    ...
    id_specialite = Column(Integer, ForeignKey("specialite.id", ondelete="CASCADE"), nullable = False)
    code_classe = Column(String(10), ForeignKey("classe.code", ondelete="CASCADE"), nullable = False)
    code_filiere = Column(String(6), ForeignKey("filiere.code", ondelete="CASCADE"), nullable = False)
    nom_seance = Column(String(10), ForeignKey("type_seance.nom", ondelete="CASCADE"), nullable = False)
...
class Activite(Base):
    ...
    code_salle= Column(String(10), ForeignKey("salle.code", ondelete="CASCADE"), nullable = False)
